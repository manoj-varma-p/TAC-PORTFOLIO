...
export default function SocialBar() {
  ...
  return (
    <div className="animate-stats flex w-full items-center justify-between gap-4 border-t border-border/70 py-4 sm:gap-6 sm:py-5">
      <div className="flex min-w-0 flex-1 items-center gap-4 sm:gap-6">
        <div className="flex shrink-0 items-center gap-2.5 sm:gap-3">
          <span className="text-xl sm:text-2xl font-extrabold leading-none text-gold">
            10K
          </span>
          <span className="text-[10px] sm:text-[11px] font-medium leading-snug tracking-[0.1em] text-gray-muted whitespace-nowrap">
            WORTH OF
            <br />
            TOOLS
          </span>
      ...
      <div className="flex shrink-0 items-center gap-2.5 sm:gap-4">
        <span className="text-[10px] sm:text-[11px] font-medium tracking-[0.15em] text-gray-muted whitespace-nowrap">
          FOLLOW US
        </span>
        <div className="flex items-center gap-2 sm:gap-2.5">
          <a
            ...
            className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full border border-border text-gray-light transition-all hover:scale-110 hover:border-gold hover:text-gold hover:shadow-[0_0_12px_rgba(255,184,0,0.4)]"
          >
