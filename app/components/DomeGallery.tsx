...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const step = () => {
      ...
      const idleFor = t - lastDragEndAt.current;
      const canRotate =
        !draggingRef.current &&
        !focusedElRef.current &&
        !inertiaRAF.current &&
        idleFor >= autoRotateResumeDelay;
  ...
  useGesture(
    {
      ...
      onDrag: ({
        ...
        if (last) {
          ...
          if (movedRef.current) lastDragEndAt.current = now();
          movedRef.current = false;
        }
      },
    },
          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute block overflow-hidden cursor-pointer bg-black transition-transform duration-300"
                    role="button"
                    tabIndex={0}
