    ...
    >
          ...
          {items.map((item, i) =>
            item.caption ? (
              <span
                ...
                className={`morph-slider-caption-text pointer-events-none inline-block rounded-[10px] bg-[rgba(10,10,12,0.65)] px-[16px] py-[10px] text-[15px] font-semibold tracking-[0.02em] text-white border border-white/10 backdrop-blur-[12px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] [grid-area:1/1] [justify-self:start] [transition:opacity_var(--ms-swap)_cubic-bezier(0.16,1,0.3,1),transform_var(--ms-swap)_cubic-bezier(0.16,1,0.3,1),filter_var(--ms-swap)_cubic-bezier(0.16,1,0.3,1)] ${
                  i === index
      ...
      {showControls && (
        <div className="absolute top-1/2 left-0 right-0 z-[3] flex justify-between px-4 -translate-y-1/2 pointer-events-none">
          <button
            type="button"
            className="pointer-events-auto inline-flex items-center justify-center w-11 h-11 rounded-full text-white border border-white/20 bg-[rgba(12,12,14,0.6)] backdrop-blur-md cursor-pointer transition-all duration-200 hover:scale-110 hover:border-gold hover:text-gold hover:bg-[rgba(24,24,28,0.8)] active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold shadow-lg"
        ...
        >
          {items.map((item, i) => (
            <button
              ...
              className={`h-2 rounded-full cursor-pointer [transition:width_var(--ms-dot)_cubic-bezier(0.16,1,0.3,1),background-color_var(--ms-dot)_ease] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold ${
                i === index ? 'w-[26px] bg-gold' : 'w-2 bg-white/35 hover:bg-white/60'
              }`}
              onClick={() => {
