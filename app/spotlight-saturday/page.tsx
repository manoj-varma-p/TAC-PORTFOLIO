...
const GUEST_SPEAKERS_DATA: Omit<GuestSpotlightItem, "id" | "edition" | "imageSrc">[] = [
  ...
  {
    guestName: "Noel Sean",
    role: "Rapper • Actor • Composer • Television Host",
    topic: "Independent Music, Screen Acting & Multidisciplinary Entertainment",
    date: "Weekend Edition #08",
    about: [
      "Noel Sean is a pioneering Indian rapper, composer, actor, and television host who introduced independent Telugu hip-hop and rap into mainstream pop culture and cinema. Starting his career as an audio designer and RJ, he made his screen debut in S. S. Rajamouli's Vikramarkudu and has since starred in numerous acclaimed Telugu films, music videos, and independent chartbusters.",
      "Widely recognized for his dynamic energy, lyrical versatility, and prominent journey on Bigg Boss Telugu 4, Noel shared his creative philosophy on blending musical rhythm with screen presence. His masterclass illuminated how artists can forge their own independent creative identities across music, cinema, and live performance.",
    ],
    keyAdvice: [
      "Pioneer your own sound—authenticity in regional music creates universal resonance.",
      "Multidisciplinary versatility across acting, music, and hosting opens boundless career avenues.",
      "Channel raw emotion and rhythm into every visual performance.",
    ],
    quote: "When rhythm lives in your pulse, every art form speaks the same language.",
    tags: ["NoelSean", "TeluguRap", "MusicComposer", "Actor", "BiggBossTelugu", "HipHop", "IndieArtist"],
  },
  {
